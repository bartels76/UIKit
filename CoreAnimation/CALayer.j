...
@implementation CALayer : CPObject
{
    ...
    DOMElement          _DOMElement @accessors(getter=_DOMElement;setter=_setDOMElement:);
    DOMElement          _DOMContentsElement @accessors(getter=_DOMContentsElement;setter=_setDOMContentsElement:);
    id                  _contents;
    CGContext           _context;
    UIView              _owningView;
